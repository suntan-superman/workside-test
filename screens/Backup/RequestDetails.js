...
const RequestDetails = () => {
  ...
  const showMode = (currentMode) => {
    ...
    setMode(currentMode)
    console.log("Pressed " + isPickerShow)
  }
  ...
  return (
    <View style={styles.screenFrame}>
      ...
      {  /* Request Data Field */ }
      {/* <Text style={[styles.requestLabel, styles.infoFieldStyle]}>{` `}</Text> */}
      <Text style={[styles.fieldHeight, styles.requestPosition]} />
      {/* <View style={[styles.fieldHeight, styles.requestPosition]} /> */}
      ...
      <Text
        style={[styles.fieldHeight, styles.commentsPosition]}
      />
      ...
      <Text
        style={[styles.fieldHeight, styles.preferredVendorPosition]}
      />
      ...
      <Text
          style={[styles.fieldHeight, styles.dateRequestedPosition]}
        />
      </TouchableOpacity>
      ...
      <TouchableOpacity onPress={(() => showMode('time'))}>
        ...
        <Text
          style={[styles.fieldHeight, styles.timeRequestedPosition]}
        />
      </TouchableOpacity>
      ...
      <View
        style={[styles.fieldHeight, styles.linkedToPosition]}
      />
